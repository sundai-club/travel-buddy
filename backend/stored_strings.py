...
itinerary_system_prompt = """
  ...
  You will receive a location, date, who I am traveling with, preferences on activities, and someadditional preferences.
  You will generate an itinerary. 
  """


json_system_prompt = f"""
You are a helpful assistant which converts text to json. 
You will receive a travel itinerary in text format, and break it up into days (these are the keys). 
